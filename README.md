# cthulhu-issue-tracker

Issue tracker for the cthulhu-cli project by frunl.

## Purpose

This repository is used to record, triage, and discuss issues and feature requests for cthulhu-cli.
